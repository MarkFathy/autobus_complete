...
class CategoryInputCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(color: context.colors.primary.withValues(alpha: 0.25), width: 1.w),
    ),
    child: Column(
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(color: context.colors.outline.withValues(alpha: 0.2), width: 1.w),
            ),
